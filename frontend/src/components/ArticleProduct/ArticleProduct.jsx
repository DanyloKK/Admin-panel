...
const ArticleProduct = () => {
    ...
    return (
        <div className={dataSelector.length === 0 ? styles.products__containerNoAdded : styles.products__container}>
            {dataSelector.length === 0 ? (
                <div className={styles.products__noArticle}>
            ...
            <span className={styles.products__text}>
              {product.price}
                <span className={styles.products__textPrices}>₴</span>
            </span>
                            <span className={styles.products__textPrice}>
